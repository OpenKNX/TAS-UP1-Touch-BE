...
#define MAIN_ApplicationNumber 11
#define MAIN_ApplicationVersion 1
#define MAIN_ParameterSize 3926
#define MAIN_MaxKoNumber 667
#define MAIN_OrderNumber "TAS-UP1-Touch-BE"
...
#define BTN_ReactionTimeMultiClick    26      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeLong          27      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeExtraLong     28      // 8 Bits, Bit 7-0
...
#define THP_KoCalcIndex(number) ((number >= THP_KoCalcNumber(0) && number < THP_KoCalcNumber(THP_KoBlockSize)) ? (number - THP_KoOffset) % THP_KoBlockSize : -1)
...
#define BTN_ChannelCount 24

// Parameter per channel
#define BTN_ParamBlockOffset 2702
